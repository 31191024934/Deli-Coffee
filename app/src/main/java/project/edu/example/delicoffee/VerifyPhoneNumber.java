...
public class VerifyPhoneNumber extends AppCompatActivity {
    ...
    private void initUi() {
        edt_phone=findViewById(R.id.verify_edt_number);
        btn_phone=findViewById(R.id.verify_btn_number);
    }
        ...
        PhoneAuthOptions options =
                PhoneAuthOptions.newBuilder(mAuth)
                        ...
                        .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            @Override
                            public void onCodeSent(@NonNull String verifycation, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                                super.onCodeSent(verifycation, forceResendingToken);
                                goToEnterOtp(strphone,verifycation);
                            }
    ...
    private void goToEnterOtp(String strphone, String verifycation) {
    }
